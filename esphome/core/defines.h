...
#define USE_COAP_SERVER_PORT 5683          // NOLINT
#define USE_COAP_SERVER_MAX_CLIENTS 2      // NOLINT
#define USE_COAP_SERVER_TWT_QUEUE_DEPTH 8  // NOLINT
#define USE_COAP_OSCORE
